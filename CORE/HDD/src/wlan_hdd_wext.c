                            ...
                            union iwreq_data *wrqu, char *extra)
{
   ...
   /* The max value of v_U16_t is 65535. 'len' should the integer number
    * of 65536 plus one charactor for null terminating. @xiaomi.com
    */
   int len = 5 + 1;
   v_U16_t link_speed;
   hdd_station_ctx_t *pHddStaCtx = WLAN_HDD_GET_STATION_CTX_PTR(pAdapter);
...
static const struct iw_priv_args we_private_args[] = {
   ...
   /* handlers for main ioctl GET_WAPI_BKID */
        ...
        "setpowerparams" },
    {
        ...
        IW_PRIV_TYPE_CHAR | 6, "getLinkSpeed" },
